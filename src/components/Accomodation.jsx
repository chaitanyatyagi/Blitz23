			...
			<div className="accomodation-container">
				<div className="accomodation-details-page">
					...
					<div className="accomodation-body">
						Blitzschlag (commonly known as Blitz), since its inception in 2005, has continued to grow in stature and outreach. The overwhelming crowd hosted by Blitz year after year experiences a cultural extravaganza and makes memories that are worth remembering for a lifetime. With attendees and participants coming from far and wide, the hospitality of our guests is of prime importance.

						We, at Blitzschlag, work towards ensuring the pleasant and comfortable stay of our guests. We shall try to fulfill the needs of secure accommodation away from home. We strive to make your stay comfortable and your experience a memorable one.

						We look forward to seeing you at Blitzschlag 2023.
					</div>
				...
				{formActive && (
					<div className="accomodation-form-popup">
						...
						<div className="row-wrapper">
							{
								packages[activePackage].head != "Mirage" ? <div className="accomodation-form-selectors">
							...
							{
								packages[activePackage].head != "Envision" ? <div className="accomodation-form-selectors">
