...
export default function Payment(props) {
    ...
    function payment(e) {
        console.log(utr)
        e.preventDefault()
        axios.post(`${process.env.REACT_APP_SERVER}/events/registration`, { eventName: props.eventName, userId: props.userId, utrId: utr, teamName: props.teamName, members: props.members })
