            ...
            <div className="main_nav" >
                ...
                <div className="nav_links">
                    ...
                    <div className={IsMobile ? "mobile" : "laptop"} ref={navRef}>
                        ...
                        <Link to="/sponsors" className="centertabs" onClick={() => hideNav()} onBlur={() => hideNav()}>SPONSORS</Link>
                        <div>
                            <NavDropdown
                                ...
                                className="navdrop"
                            >
                                <NavDropdown.Item><Link to="/schedule" className="text-white" onClick={() => hideNav()} onBlur={() => hideNav()}>SCHEDULE</Link></NavDropdown.Item>
