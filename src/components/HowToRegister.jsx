    ...
    return (
        <div className="howtoregister">
            ...
            <div className="how2regins">
                ...
                <ReactPlayer url='https://video.blitzschlag.co.in/video/id_video_5/_manifest.mpd' width="70%" height="100%" playing controls className="video-div" />
            </div>
            <div className="how2regins">
                <div className="how2reginshead">How to register in an event (for NON MNIT Jaipur & NON IIIT Kota students in ANDROID)?</div>
                <ReactPlayer url='https://video.blitzschlag.co.in/video/id_video_7/_manifest.mpd' width="70%" height="100%" playing controls className="video-div" />
            </div>
